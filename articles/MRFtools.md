...
```
    ...
    # A tibble: 120 × 4
       ...
       <fct>    <dbl> <dbl> <dbl>
     1 sp_11        1 0.534 0.555
     2 sp_11        1 0.534 0.617
     3 sp_11        1 0.534 0.447
     4 sp_11        1 0.534 0.694
     5 sp_11        1 0.534 0.403
     6 sp_11        1 0.534 0.328
     7 sp_11        1 0.534 0.520
     8 sp_11        1 0.534 0.328
     9 sp_11        1 0.534 0.430
    10 sp_11        1 0.534 0.687
    # ℹ 110 more rows
...
```
    ...
    Generalized Additive Model with 2 terms
      ...
      term       type           k   edf ref.edf statistic p.value
      <chr>      <chr>      <dbl> <dbl>   <dbl>     <dbl> <chr>
    1 Intercept  parametric    NA   1         1     -1.11 0.271
    2 s(species) MRF           11  10.9      11    903.   <0.001 
